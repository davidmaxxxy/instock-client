  ...
  return (
    <PageWrapper title={"Warehouses"} location={"Warehouses"}>
          ...
          {!loading ? (
            ...
            <WarehousesElementMobile key={warehouse.id} warehouse={warehouse} />
          ))}
            </section>
            ):(
              <div>
      ...
      <thead className="table-header">
          <tr className="table-header__cell">
            <th className="table-header__element"><h4>WAREHOUSE</h4> <img className="table-header__btn-sort" src={btnSort} alt="Sort"/> </th> 
          </tr>
